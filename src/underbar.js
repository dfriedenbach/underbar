(function() {
  ...
  _.last = function(array, n) {
    ...
    var start = (n >= array.length ? 0 : array.length - n);
  ...
  _.reduce = function(collection, iterator, accumulator) {
    _.each(collection, function(value) {
      accumulator = (accumulator === undefined ? value : iterator(accumulator, value));
    });
    return accumulator;
  };
  ...
  _.invoke = function(collection, functionOrKey, args) {
    ...
    _.each(collection, function(value) {
      ...
      } else if(typeof value[functionOrKey] === 'function') {
  ...
  _.zip = function() {
    ...
    var lengths = _.map(arguments, function(value){
      return value.length;
    });
    var length = Math.max.apply(this, lengths);
    var result = [];
  ...
  _.difference = function(array) {
    if(arguments.length < 2) {
      ...
      _.each(array, function(value) {
        var diff = _.every(others, function(collection) {
